...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'version'            => '2.7.23', // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
